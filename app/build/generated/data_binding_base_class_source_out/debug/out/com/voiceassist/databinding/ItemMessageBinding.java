...
public final class ItemMessageBinding implements ViewBinding {
  ...
  private ItemMessageBinding(@NonNull LinearLayout rootView, @NonNull CardView messageCard,
      @NonNull TextView messageText, @NonNull TextView senderName,
  ...
  public static ItemMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageBinding((LinearLayout) rootView, messageCard, messageText, senderName,
          timestampText);
    }
